---
title: 'Introdução'
description: 'API da plataforma Upscale Commerce para integração com sistemas externos (ERPs, gateways, marketplaces).'
---

## O que é

A **Upscale Commerce API** é o ponto de integração entre a plataforma de e-commerce e sistemas externos que precisam sincronizar catálogo, estoque, preço e pedidos.
